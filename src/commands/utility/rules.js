const { SlashCommandBuilder, ButtonStyle, MessageFlags, ContainerBuilder, ActionRowBuilder, ButtonBuilder } = require("discord.js");
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const onRules = new ContainerBuilder()
      ...
      .addTextDisplayComponents((textDisplay) => textDisplay.setContent("**1.** No Spam.\n**2.** No NSFW.\n**3.** No Bullying.\n**4.** Follow Discord TOS."))
      .addSeparatorComponents((separator) => separator)
